...
const createNewProduct = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        let result = yield (yield db.exec("createNewProduct", { id, productName, productDescription, price, productImageUrl, category, productStock })).rowsAffected;
        console.log(result);
...
const getProducts = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        let products = category ? (yield db.exec("getProductsByCategory", { category })).recordset : (yield db.exec('getAllProducts')).recordset;
        if (!products.length) {
...
const getAProduct = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        let { id } = req.params;
        let products = (yield db.exec("getProductById", { id })).recordset[0];
        if (!products) {
...
const updateProduct = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        let product = yield (yield db.exec('getProductById', { id })).recordset[0];
        if (!product) {
            return res.status(404).json({ message: 'The product does not exist' });
        }
        yield db.exec('updateProduct', { id, productName, productDescription, price, productImageUrl, category, productStock });
...
const deleteProduct = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        let { id } = req.params;
        let product = (yield db.exec("getProductById", { id })).recordset[0];
        if (!product) {
            return res.status(404).json({ message: 'No product found' });
        }
        yield (yield db.exec('deleteProduct', { id })).recordset;

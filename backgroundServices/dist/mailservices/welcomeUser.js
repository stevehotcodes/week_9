...
const welcomeUser = () => __awaiter(void 0, void 0, void 0, function* () {
    ...
    const users = yield (yield pool.request().query('SELECT * FROM users WHERE isDeleted= 0')).recordset;
    console.log(users);
    for (let user of users) {
        ejs_1.default.renderFile('templates/welcomeUser.ejs', { Name: user.firstname }, (error, data) => __awaiter(void 0, void 0, void 0, function* () {
            ...
            try {
                ...
                yield pool.request().query('UPDATE users SET isDeleted = 1 WHERE isDeleted = 0');
